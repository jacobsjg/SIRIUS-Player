...
siriusplayer = {
  ...
  onLoad: function()
  {
    ...
    {
      document.getElementById("siriusplayer-preferences-settings-tab").disabled = 1;
      document.getElementById("siriusplayer-preferences-tabbox").selectedTab = document.getElementById("siriusplayer-preferences-legal-tab");
    }
    else
    {
      var auth = siriusplayer.player.getAuthInfo();
      document.getElementById('siriusplayer-pref-username-field').value = auth.username || '';
      document.getElementById('siriusplayer-pref-password-field').value = auth.password || '';
    }
  },
