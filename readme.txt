...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\siriusplayer on
     Windows, /home/user/dev/siriusplayer on Linux) in a file named
     siriusplayer@dustywilson.com and copy that file to
